...
// Auth information
global.pairNumber = "254757848863";                         // Add your paining number with country code example "916297175943"; 
...
// Owner information
global.Owner = process.env.OWNER ? process.env.OWNER.split(",") : ["254757848863"];
global.OwnerNumber = process.env.OWNER_NUMBER ? process.env.OWNER_NUMBER.split(",") : ["254757848863"];
global.ownertag = process.env.OWNER_TAG ? process.env.OWNER_TAG.split(",") : ["254757848863"];
global.OwnerName = process.env.OWNER_NAME || "Mony";
global.BotName = process.env.BOT_NAME || "A17";
global.packname = process.env.PACK_NAME || "A17 Bot";
global.author = "By: Mony";
